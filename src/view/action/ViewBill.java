...
public class ViewBill extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_bill_30px.png"))); // NOI18N

        jLabel23.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel23.setText("Print Bill");
        ...
        btnPrintBillLayout.setVerticalGroup(
            ...
            .addGroup(btnPrintBillLayout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addGroup(btnPrintBillLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        txtCusPay.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txtCusPay, javax.swing.GroupLayout.PREFERRED_SIZE, 413, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel16)
                    .addComponent(txtCusPay, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(txtExcessCash))
    ...
    private void btnPrintBillMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPrintBillMouseClicked
        ...
        o.setTotal_money(Float.parseFloat(txtTotal.getText().replace(".", "")));
        o.setCus_pay(Float.parseFloat(txtCusPay.getText()));
        o.setCus_receive(Float.parseFloat(txtExcessCash.getText().replace(".", "")));
        o.setCashier(txtCashier.getText());
        orderDAO.add(o);

        for (OrderDetails od : listOrderDetails) {
            orderDetailDAO.add(od);
        }
        new SuccessfulMessageDialog().setMassage("Print bill successfully!");
        this.dispose();
    ...
    private void txtCusPayKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCusPayKeyReleased
        ...
        try {
            int totalMoney = Integer.parseInt(txtTotal.getText().replace(".", ""));
            int cus_pay = Integer.parseInt(txtCusPay.getText());
            int excess_cash = cus_pay - totalMoney;

            if (excess_cash > 0) {
                txtExcessCash.setText(vn.format(excess_cash));
            } else {
                txtExcessCash.setText(0 + "");
            }
        } catch (Exception e) {
    ...
    public void setData(Integer orderID, List<OrderDetails> listOD) {
        Locale localeVN = new Locale("vi", "VN");
        NumberFormat vn = NumberFormat.getInstance(localeVN);
        ...
        String cashierName = "Lay tu ten nguoi dung";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                ViewBill dialog = new ViewBill(new javax.swing.JFrame(), true);
